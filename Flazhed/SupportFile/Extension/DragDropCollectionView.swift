...
//
    ...
    fileprivate func commonInit() {
        ...
        //if newIndexPath.row<DataManager.imageCount
        //{
            ...
            if draggedCellIndexPath != nil {
                ...
                dispatchOnMainQueueAfter(pingInterval, closure: { () -> () in
                    ...
                    if shouldSwapCellsTuple.shouldSwap {
                        ...
                        if shouldSwapCellsTuple.newIndexPath!.row<DataManager.imageCount
                        {
        ...
        case UIGestureRecognizerState.ended:
            if draggedCellIndexPath != nil {
                ...
                UIView.animate(withDuration: 0.4, animations: { () -> Void in
                    ...
                    if (draggedCell != nil) {
                        self.draggingView?.center = draggedCell?.center ?? CGPoint(x: 0, y: 0)
                    }
