...
@objc func reachabilityChanged(note: Notification) {
    ...
    case .cellular:
        ...
        self.isNetworkAvaible=true
//        if !DataManager.isInternetAvailble
//        {
//        Util.showAlert(kEmptyString, kOnlineMessage)
//        }
...
//        }
    ...
    case .unavailable:
       ...
       // self.isNetworkAvaible=false
       // DataManager.isInternetAvailble=false
        //Util.showAlert(kEmptyString, kOfflieMessage)
...
class Util {
    ...
    static func showAlert(_ title: String, _ message: String) {
        ...
        UIApplication.shared.keyWindow?.rootViewController?.present(alert,animated:true,completion:{Timer.scheduledTimer(withTimeInterval: 2, repeats:false, block: {_ in
